...
public class SecurityConfiguration {
    ...
    private static final String[] FRONTEND_ROUTES = {"/sign-in", "/signed-in/**"};
    private static final String[] HOSTED_STATIC_FILES_PATHS = {"/favicon.ico", "/app.*", "/utils/**", "/pages/**", "/components/**"};
